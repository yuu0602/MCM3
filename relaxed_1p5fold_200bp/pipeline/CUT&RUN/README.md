...
Step 04 otherwise refilters existing candidate calls and recomputes binding.
Promoter overlap requires >=200 bp and factor/IgG >=1.5 in both replicates;
the separate whole-genome atomic-segment minimum remains 250 bp.
