...
| 03 | `bulkRNAseq/03_render_figures.py --igv-tracks` | Optional RNA-seq IGV tracks: a local-SSD HISAT2 index build, MAPQ >=30/proper-pair filtering, CPM bigWigs, and group means |
